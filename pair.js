...
┖❑`;
              ...
              case 'pair': {
                ...
                try {
                    ...
                    await socket.sendMessage(sender, {
                        text: `> *ANTIBUG  𝐌𝙸𝙽𝙸 𝐁𝙾𝚃 𝐏𝙰𝙸𝚁 𝐂𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
                    }, { quoted: msg });
...
*📋 Status:* Sending audio now...`
                ...
                await socket.sendMessage(sender, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: '🎵 MP3 Audio | Powered by Antibug Tech',
              ...
              case 'ai': {
                ...
                const prompt = `You are Antibug an Ai developed By Antibug Tech , When asked about your creator say Antibug Tech and when u reply to anyone put a footer below ur messages > powered by Antibug tech, You are from Zimbabwe,
